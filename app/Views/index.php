            ...
            <div class="row justify-content-center">
                <div class="col-lg-5 py-5">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="info-box">
                                <img src="<?= base_url('assets/img/icon6.png')?>" alt="">
                                <div class="ms-4">
                        ...
                        <div class="col-12 mt-4">
                            <div class="info-box">
                                <img src="<?= base_url('assets/img/icon4.png')?>" alt="">
                                <div class="ms-4">
    ...
    <section class="bg-light" id="portfolio">
        ...
        <div id="projects-slider" class="owl-theme owl-carousel">
            <div class="project">
                ...
                <img src="<?= base_url('assets/img/project1.jpg')?>" alt="">
                <div class="content">
            ...
            <div class="project">
                <div class="overlay"></div>
                <img src="<?= base_url('assets/img/project3.jpg')?>" alt="">
                <div class="content">
                    <h2>Consulting Marketing</h2>
                    <h6>Website Design</h6>
                </div>
            ...
            <div class="project">
                <div class="overlay"></div>
                <img src="<?= base_url('assets/img/project4.jpg')?>" alt="">
                <div class="content">
                    <h2>Consulting Marketing</h2>
                    <h6>Website Design</h6>
                </div>
            ...
            <div class="project">
                <div class="overlay"></div>
                <img src="<?= base_url('assets/img/project5.jpg')?>" alt="">
                <div class="content">
                    <h2>Consulting Marketing</h2>
                    <h6>Website Design</h6>
                </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-8">
                    <div class="team-member">
                        <div class="image">
                            <img src="<?= base_url('assets/img/team_1.jpg')?>" alt="">
                ...
                <div class="col-lg-4 col-md-8">
                    <div class="team-member">
                        <div class="image">
                            <img src="<?= base_url('assets/img/team_2.jpg')?>" alt="">
                            <div class="social-icons">
                                <a href="#"><i class='bx bxl-facebook'></i></a>
                                <a href="#"><i class='bx bxl-twitter'></i></a>
                                <a href="#"><i class='bx bxl-instagram'></i></a>
                ...
                <div class="col-lg-4 col-md-8">
                    <div class="team-member">
                        <div class="image">
                            <img src="<?= base_url('assets/img/team_3.jpg')?>" alt="">
                            <div class="social-icons">
                                <a href="#"><i class='bx bxl-facebook'></i></a>
                                <a href="#"><i class='bx bxl-twitter'></i></a>
                                <a href="#"><i class='bx bxl-instagram'></i></a>
    ...
    <section id="blog">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <article class="blog-post">
                        <img src="<?= base_url('assets/img/project2.jpg')?>" alt="">
                    ...
                    <div class="container-fluid">
                        <div class="row gy-4">
                            <div class="col-lg-4 col-sm-12 bg-cover"
                                style="background-image: "<?= base_url('assets/img/c2.jpg') ?>"; min-height:300px;">
                                <div>
